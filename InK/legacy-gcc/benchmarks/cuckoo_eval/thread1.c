...
__shared(
    ...
    uint8_t pinRaised; fingerprint_t _v_filter[NUM_BUCKETS]; index_t _v_index;
    value_t _v_key; enum task_index _v_next_task; fingerprint_t _v_fingerprint;
    value_t _v_index1; value_t _v_index2; value_t _v_relocation_count;
    value_t _v_insert_count; value_t _v_inserted_count; value_t _v_lookup_count;
    value_t _v_member_count; bool _v_success; bool _v_member;)
