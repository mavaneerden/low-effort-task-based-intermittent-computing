...
__shared(queue_t queue[Q_SIZE]; // largest size?
         uint16_t deq_idx; uint16_t enq_idx; uint16_t node_idx;
         uint16_t src_node; queue_t nearest_node; node_t node_list[N_NODES];)
