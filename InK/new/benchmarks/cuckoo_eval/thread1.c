...
static void* task_init_array();
static void* task_generate_key();
static void* task_calc_indexes();
static void* task_calc_indexes_index_1();

static void* task_calc_indexes_index_2();
static void* task_insert();
static void* task_add();
static void* task_relocate();
static void* task_insert_done();

static void* task_lookup();
static void* task_lookup_search();
static void* task_lookup_done();
