...
#   - Disallow extern task functions/shared variables
#   - Instrument all shared variables that are used in the global scope but not in tasks
...
#   - Extern shared variables (check if error)
# - Arrays ✔
#   - Read
