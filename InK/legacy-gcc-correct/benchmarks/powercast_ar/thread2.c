...
__shared(uint16_t status; int16_t array_X[N_SAMPLES]; int16_t array_Y[N_SAMPLES]; int16_t array_Z[N_SAMPLES];
         int16_t                                                                          minFeatureZ;
         int16_t                                                                          maxFeatureZ;
...
TASK(t_distance)
{
    uint16_t ACT1_eudistance = isqr_Newton(
        ipow(ACT1_trained_maxZ - __GET(maxFeatureZ)) + ipow(ACT1_trained_meanFeature - __GET(meanFeature)) +
        ipow(ACT1_trained_stddevFeature - __GET(stddevFeature)) + ipow(ACT1_trained_minZ - __GET(minFeatureZ)));

    uint16_t ACT2_eudistance = isqr_Newton(
        ipow(ACT2_trained_maxZ - __GET(maxFeatureZ)) + ipow(ACT2_trained_meanFeature - __GET(meanFeature)) +
        ipow(ACT2_trained_stddevFeature - __GET(stddevFeature)) + ipow(ACT2_trained_minZ - __GET(minFeatureZ)));

    uint16_t ACT3_eudistance = isqr_Newton(
        ipow(ACT3_trained_maxZ - __GET(maxFeatureZ)) + ipow(ACT3_trained_meanFeature - __GET(meanFeature)) +
        ipow(ACT3_trained_stddevFeature - __GET(stddevFeature)) + ipow(ACT3_trained_minZ - __GET(minFeatureZ)));
